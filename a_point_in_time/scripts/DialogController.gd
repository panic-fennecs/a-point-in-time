...
const STRING_DICT = {
	...
	# explore
	"take-seed-future-table": ["The seed's lying around here like it's important.", "Maybe I'll find a good place for it."],
	...
	"take-seed-future-pot": ["Maybe the right place for this seed is in another spot.", "Let's see.. *thinking*s"],
