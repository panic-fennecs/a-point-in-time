...
const STRING_DICT = {
	...
	"discover-timemachine": ["Hm.. weird, can't remember this room.", "What kind of machine is this? Sign says 'Time Machine (Dr. E. Brown Enterprises)'.", "Haha, my old gramps always loved jokes like that.", "This reminds me of 'Doctor Who and the Tardis'. I wonder how this thing looks from the inside."],
	...
	# explore
	"take-seed-future-table": ["This seed's lying around here like it's important.", "Maybe I'll find a good place for it to grow."],
	...
	"sheet": [
		...
		"And maybe the mentioned key is still here."],
	...
	"shelf-scroll": ["Hm.. in this shelf are just some scrolls. Perhaps there is more information in one of the other ones."],
	...
	# end
	"end-sequence": [
	"After Mabel traveled between the present and future, she successfully completed the time machine's mechanism to reach the time in the past.",
	"Searching for her grandpa she suddenly stopped when she wanted to leave the basement...",
	"Mabel: 'Grandpa!'"],
